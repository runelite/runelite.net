module.exports = {
  ...
  buttons: [
    {
      link:
        'https://github.com/runelite/launcher/releases/download/2.6.0/RuneLiteSetup32.exe',
    ...
    {
      link:
        'https://github.com/runelite/launcher/releases/download/2.6.0/RuneLiteSetup.exe',
      icon: 'fab fa-fw fa-windows',
      text: {
        os: 'Windows',
        arch: '64 bit'
    ...
    {
      link:
        'https://github.com/runelite/launcher/releases/download/2.6.0/RuneLite-x64.dmg',
    ...
    {
      link:
        'https://github.com/runelite/launcher/releases/download/2.6.0/RuneLite-aarch64.dmg',
      icon: 'fab fa-fw fa-apple',
      text: {
        os: 'macOS',
        arch: 'Apple silicon'
    ...
    {
      link:
        'https://github.com/runelite/launcher/releases/download/2.6.0/RuneLite.jar',

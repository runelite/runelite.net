module.exports = {
  ...
  buttons: [
    {
      link:
        'https://github.com/runelite/launcher/releases/download/2.0.0/RuneLiteSetup32.exe',
    ...
    {
      link:
        'https://github.com/runelite/launcher/releases/download/2.0.0/RuneLiteSetup.exe',
      icon: 'fab fa-fw fa-windows',

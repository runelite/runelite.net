// https://github.com/disqus/disqus-react/blob/master/src/DiscussionEmbed.jsx ported to React
import { h, Component } from 'preact'
import { insertScript, removeScript } from '../util'

export class DisqusThread extends Component {
  componentWillMount() {
    if (

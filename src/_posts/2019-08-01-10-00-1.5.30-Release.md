...
- Add Gauntlet kill count and personal best support to chat commmands
...
Item despawn timers have been added to the ground items plugin, which shows how
...
The world hopper plugin now has an option to show the current worlds ping
...
- Fix removing teleblock timer when your opponent who casted the teleblock dies
...
- Incrase smelting overlay timeout to account for cannonballs

---
title: '1.6.29, 1.6.30, and 1.6.31 Release'
...
plugin](https://github.com/runelite/runelite/wiki/GPU) to assist users suffering from protanopia,
deuteranopia, or tritanopia. Thanks to [@benpoulson](https://github.com/benpoulson) for porting
...
We have released an updated launcher which adds better support for users with hi-DPI displays and
displays of varying sizes and orientations.
...
- [XP Globes](https://github.com/runelite/runelite/wiki/XP-Globes) can now be stacked vertically,
  using the same method to flip their orientation as infoboxes. (<kbd>Shift</kbd> + right-click)
...
- You can check your league points using the newly-added [`!lp` chat
  command](https://github.com/runelite/runelite/wiki/Chat-Commands). Other chat commands have been
...
We had 37 contributors this release!
